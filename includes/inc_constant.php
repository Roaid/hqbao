...
/* 订单状态 */
define('OS_UNCONFIRMED',            0); // 未确认去掉了
define('OS_CONFIRMED',              1); // 未付款
...
/* 订单商品状态 */
define('TB_UNPAY',                   0); // 未付款
define('TB_UNDAIGOU',                1); // 待配货
define('TB_DAIGOU',                  2); // 配货种
define('TB_DAOHUO',                  3); // 到货
define('TB_TUIHUO',                  4); // 申请退货

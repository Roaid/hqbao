...
function insert_history()
{
    ...
    if (!empty($_COOKIE['ECS']['history']))
    {
        ...
        while ($row = $GLOBALS['db']->fetch_array($query))
        {
			...
			$str.='<div class="tif_li"><div class="ti_le"><a href="'.$goods['url'].'" target="_blank"><img src="'.$goods['goods_thumb'].'" alt="'.$goods['goods_name'].'" width="90" height="90"/></a></div><div class="ti_ri"><font><a href="'.$goods['url'].'" target="_blank" title="'.$goods['goods_name'].'">'.$goods['short_name'].'</a></font>'.$GLOBALS['_LANG']['shop_price'].'<strong>'.$goods['shop_price'].'</strong></div></div>';
        }

...
/* 订单状态 */
$_LANG['os'][OS_UNCONFIRMED] = '未付款';
$_LANG['os'][OS_CONFIRMED] = '已付款';
...
//define('SS_SHIPPED_SQ',             6); // 申请发货


$_LANG['ss'][SS_UNSHIPPED] = '配货中';
$_LANG['ss'][SS_PREPARING] = '配货完成';
$_LANG['ss'][SS_SHIPPED] = '已发货';
$_LANG['ss'][SS_RECEIVED] = '收货确认';
$_LANG['ss'][SS_SHIPPED_PART] = '已发货(部分商品)';
$_LANG['ss'][SS_SHIPPED_ING] = '发货中';
$_LANG['ss'][SS_SHIPPED_SQ] = '已申请发货';

$_LANG['ps'][PS_UNPAYED] = '未支付';
$_LANG['ps'][PS_PAYING] = '支付中';
$_LANG['ps'][PS_PAYED] = '已支付';

$_LANG['tb'][TB_UNPAY] = '未付款';
$_LANG['tb'][TB_UNDAIGOU] = '待配货';
$_LANG['tb'][TB_DAIGOU] = '配货中';
$_LANG['tb'][TB_DAOHUO] = '到货';
$_LANG['tb'][TB_TUIHUO] = '申请退货';
...
$_LANG['label_weight'] = '商品重量';
$_LANG['label_ubeizu'] = '用户备注';
$_LANG['label_gbeizu'] = '管理员备注';
...
$_LANG['taobao_note'] = '申请退货,如果同意,请直接删除,如果不同意,请设置商品的淘宝状态';

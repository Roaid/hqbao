...
$_LANG['phone'] = '电话';
$_LANG['mobile'] = '手机';
$_LANG['backup_phone'] = '国家';
$_LANG['sign_building'] = '州';
$_LANG['deliver_goods_time'] = '城市';
$_LANG['default'] = '默认';
...
$_LANG['cancel'] = '取消订单';
$_LANG['pay_money'] = '付款';
$_LANG['pay_money_fahuo'] = '支付邮费并申请发货';
...
$_LANG['product_cancel'] = '退货';


/* 订单状态 */
$_LANG['os'][OS_UNCONFIRMED] = '未付款';//1
$_LANG['os'][OS_CONFIRMED] = '已付款';//2
...
$_LANG['os']['youfei'] = '请支付邮费';

$_LANG['ss'][SS_UNSHIPPED] = '配货中';//3
$_LANG['ss'][SS_PREPARING] = '配货完成';//4
$_LANG['ss'][SS_SHIPPED_SQ] = '已申请发货';//8
$_LANG['ss'][SS_SHIPPED] = '已发货';//9
$_LANG['ss'][SS_RECEIVED] = '收货确认';//10
$_LANG['ss'][SS_SHIPPED_PART] = '已发货(部分商品)';
$_LANG['ss'][SS_SHIPPED_ING] = '发货中'; // 已分单

$_LANG['ps'][PS_UNPAYED] = '未支付';//5
$_LANG['ps'][PS_PAYING] = '支付中';//6
$_LANG['ps'][PS_PAYED] = '已支付';//7


$_LANG['tb'][TB_UNPAY] = '未付款';
$_LANG['tb'][TB_UNDAIGOU] = '待配货';
$_LANG['tb'][TB_DAIGOU] = '配货中';
$_LANG['tb'][TB_DAOHUO] = '到货';
$_LANG['tb'][TB_TUIHUO] = '已申请退货';
...
$_LANG['username_empty'] = '昵称为空';
$_LANG['username_invalid'] = '昵称 %s 含有敏感字符';
$_LANG['username_exist'] = '昵称 %s 已经存在';
$_LANG['username_not_allow'] = '昵称 %s 不允许注册';
...
$_LANG['passport_js']['username_empty'] = '- 昵称不能为空。';
$_LANG['passport_js']['username_shorter'] = '- 昵称长度不能少于 3 个字符。';
$_LANG['passport_js']['username_invalid'] = '- 昵称只能是由字母数字以及下划线组成。';
...
$_LANG['passport_js']['msg_un_blank'] = '* 昵称不能为空';
$_LANG['passport_js']['msg_un_length'] = '* 昵称最长不得超过7个汉字';
$_LANG['passport_js']['msg_un_format'] = '* 昵称含有非法字符';
$_LANG['passport_js']['msg_un_registered'] = '* 昵称已经存在,请重新输入';
